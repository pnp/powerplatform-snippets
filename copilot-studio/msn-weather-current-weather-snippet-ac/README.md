# MSN Weather - Current Weather (Action with Adaptive Card)
...
Snippet|Author(s)
--------|---------
MSN Weather - Current Weather (Action with Adaptive Card) | [Daniel Laskewitz](https://github.com/laskewitz) ([@laskewitz](https://www.twitter.com/laskewitz))
